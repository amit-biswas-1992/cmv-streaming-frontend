...
export const getServerSideProps = async (context) => {
  ...
  const data = await callApiGetWithoutToken(
    `/core/category-wise-media-content/${id}`
  );
      ...
      <>
        ...
        <div className="mx-4">
          <Image
            ...
            loader={myLoader}
            src={catdata.categoryInfo.cover_photo}
            width={1000}
            height={300}
            alt=""
          />
          ...
          {catdata.categoryWiseMediaContent.map((value) => (
            <div className="" key={value.category_id}>
              <div className="pt-4 px-2">
                <div className="grid grid-cols-4 gap-3 place-items-stretch items-center mx-3">
                  ...
                  <div className="text-lg col-span-1">
                    <h1 className="font-bold whitespace-nowrap lg:text-3xl">
                      {value.title}
                    </h1>
                    ...
                    <p className="font-thin text-cyan-400 lg:text-2xl">
                      {catdata.categoryInfo.name}
                    </p>
                  </div>

                  <div className="text-3xl lg:text-6xl lg:mr-4 ml-auto col-span-1">
                    <Link href={`/content-original/preview-new/${value.id}`}>
                      <a>
                        <FontAwesomeIcon icon={faCirclePlay} />
                      </a>
                    </Link>
